...
const routes: Routes = [
  ...
  { path: '', redirectTo: "/tienda", pathMatch: "full" }, // Redirigir a "tienda" por defecto
  { path: '**', redirectTo: "/tienda" }, // Redirigir a "tienda" para cualquier ruta no coincidente
];

@NgModule({
  imports: [RouterModule.forRoot(routes, {
    useHash: true, // Utilizar el hash en las rutas
  })],
